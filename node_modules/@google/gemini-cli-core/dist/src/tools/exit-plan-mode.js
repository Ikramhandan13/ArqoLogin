...
export class ExitPlanModeTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        ...
        super(EXIT_PLAN_MODE_TOOL_NAME, 'Exit Plan Mode', definition.base.description, Kind.Plan, definition.base.parametersJsonSchema, messageBus);
        this.config = config;
    }
...
export class ExitPlanModeInvocation extends BaseToolInvocation {
    ...
    async shouldConfirmExecute(abortSignal) {
        ...
        const pathError = await validatePlanPath(this.params.plan_path, this.config.storage.getProjectTempPlansDir(), this.config.getTargetDir());
        if (pathError) {
