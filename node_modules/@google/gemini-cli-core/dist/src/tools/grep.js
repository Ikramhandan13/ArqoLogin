...
export class GrepTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        super(GrepTool.Name, 'SearchText', GREP_DEFINITION.base.description, Kind.Search, GREP_DEFINITION.base.parametersJsonSchema, messageBus, true, false);
        this.config = config;
    }
    /**
    ...
    validateToolParamValues(params) {
        ...
        if (params.total_max_matches !== undefined &&
