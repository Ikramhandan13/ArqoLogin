 ...
 */
export function getShellToolDescription(enableInteractiveShell, enableEfficiency) {
 ...
 */
export function getShellDeclaration(enableInteractiveShell, enableEfficiency) {
    return {
 ...
 */
export function getExitPlanModeDeclaration(plansDir) {
    return {
 ...
 */
export function getActivateSkillDeclaration(skillNames) {
...
//# sourceMappingURL=dynamic-declaration-helpers.js.map