...
import type { ModelRoutingEvent, ModelSlashCommandEvent, AgentFinishEvent, RecoveryAttemptEvent, KeychainAvailabilityEvent, TokenStorageInitializationEvent } from './types.js';
...
declare const PLAN_EXECUTION_COUNT = "gemini_cli.plan.execution.count";
declare const COUNTER_DEFINITIONS: {
    ...
    readonly "gemini_cli.plan.execution.count": {
        readonly description: "Counts plan executions (switching from Plan Mode).";
        readonly valueType: ValueType.INT;
        readonly assign: (c: Counter) => Counter<Attributes>;
        readonly attributes: {
    ...
    readonly "gemini_cli.keychain.availability.count": {
        readonly description: "Counts keychain availability checks.";
        readonly valueType: ValueType.INT;
        readonly assign: (c: Counter) => Counter<Attributes>;
        readonly attributes: {
            available: boolean;
    ...
    readonly "gemini_cli.token_storage.type.count": {
        readonly description: "Counts token storage type initializations.";
        readonly valueType: ValueType.INT;
        readonly assign: (c: Counter) => Counter<Attributes>;
        readonly attributes: {
            type: string;
 ...
 */
export declare function recordPlanExecution(config: Config, attributes: MetricDefinitions[typeof PLAN_EXECUTION_COUNT]['attributes']): void;
/**
 ...
 */
export declare function recordKeychainAvailability(config: Config, event: KeychainAvailabilityEvent): void;
/**
 * Records a metric for token storage type initialization.
 */
export declare function recordTokenStorageInitialization(config: Config, event: TokenStorageInitializationEvent): void;
export {};
