...
export class ToolOutputMaskingEvent {
    'event.name';
    'event.timestamp';
    tokens_before;
    tokens_after;
...
export class KeychainAvailabilityEvent {
    'event.name';
    'event.timestamp';
    available;
...
export const EVENT_TOKEN_STORAGE_INITIALIZATION = 'gemini_cli.token_storage.initialization';
export class TokenStorageInitializationEvent {
    'event.name';
    'event.timestamp';
    type;
    forced;
