...
(function (EventNames) {
    ...
    EventNames["APPROVAL_MODE_SWITCH"] = "approval_mode_switch";
    EventNames["APPROVAL_MODE_DURATION"] = "approval_mode_duration";
    EventNames["PLAN_EXECUTION"] = "plan_execution";
    EventNames["TOOL_OUTPUT_MASKING"] = "tool_output_masking";
    EventNames["KEYCHAIN_AVAILABILITY"] = "keychain_availability";
    EventNames["TOKEN_STORAGE_INITIALIZATION"] = "token_storage_initialization";
...
export class ClearcutLogger {
    ...
    addDefaultFields(data, totalAccounts) {
        const defaultLogMetadata = [
            ...
            {
                gemini_cli_key: EventMetadataKey.GEMINI_CLI_ACTIVE_APPROVAL_MODE,
                value: typeof this.config?.getPolicyEngine === 'function' &&
