...
export declare function logToolOutputMasking(config: Config, event: ToolOutputMaskingEvent): void;
...
export declare function logPlanExecution(config: Config, event: PlanExecutionEvent): void;
