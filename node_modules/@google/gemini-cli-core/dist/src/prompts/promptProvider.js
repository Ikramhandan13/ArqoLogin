...
import { PLAN_MODE_TOOLS, WRITE_TODOS_TOOL_NAME, READ_FILE_TOOL_NAME, ENTER_PLAN_MODE_TOOL_NAME, GLOB_TOOL_NAME, GREP_TOOL_NAME, } from '../tools/tool-names.js';
...
export class PromptProvider {
    ...
    getCoreSystemPrompt(config, userMemory, interactiveOverride) {
        ...
        if (isPlanMode) {
            ...
            const readOnlyMcpTools = allTools.filter((t) => t instanceof DiscoveredMCPTool && !!t.isReadOnly);
        ...
        if (systemMdResolution.value && !systemMdResolution.isDisabled) {
            ...
            const skillsPrompt = activeSnippets.renderAgentSkills(skills.map((s) => ({
                name: s.name,
            ...
            const hasHierarchicalMemory = typeof userMemory === 'object' &&
                userMemory !== null &&
            ...
            const options = {
                ...
                subAgents: this.withSection('agentContexts', () => config
                    .getAgentRegistry()
                    .getAllDefinitions()
                    .map((d) => ({
                    name: d.name,
            ...
            const getCoreSystemPrompt = activeSnippets.getCoreSystemPrompt;
