...
describe('codeAssist', () => {
    ...
    describe('createCodeAssistContentGenerator', () => {
        ...
        it('should create a server for LOGIN_WITH_GOOGLE', async () => {
            ...
            expect(setupUser).toHaveBeenCalledWith(mockAuthClient, mockValidationHandler, httpOptions);
            expect(MockedCodeAssistServer).toHaveBeenCalledWith(mockAuthClient, 'test-project', httpOptions, 'session-123', 'free-tier', 'free-tier-name');
