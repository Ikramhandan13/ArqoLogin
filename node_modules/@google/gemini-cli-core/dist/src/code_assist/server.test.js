...
function createTestServer(headers = {}) {
...
describe('CodeAssistServer', () => {
    ...
    it('should detect error in generateContent response', async () => {
        ...
        expect(recordConversationOfferedSpy).toHaveBeenCalledWith(expect.objectContaining({
    ...
    it('should record conversation offered on successful generateContent', async () => {
        ...
        expect(server.recordCodeAssistMetrics).toHaveBeenCalledWith(expect.objectContaining({
