 ...
 */
export async function setupUser(client, validationHandler, httpOptions = {}) {
...
function validateLoadCodeAssistResponse(res) {
    ...
    if (!res.currentTier &&
        ...
        const validationTier = res.ineligibleTiers.find((t) => t.validationUrl &&
        ...
        if (validationTier && validationUrl) {
            throw new ValidationRequiredError(`Account validation required: ${validationTier.reasonMessage}`, undefined, validationUrl, validationTier.reasonMessage);
        }
    }
}
