...
export declare class Turn {
    ...
    run(modelConfigKey: ModelConfigKey, req: PartListUnion, signal: AbortSignal, displayContent?: PartListUnion, role?: LlmRole): AsyncGenerator<ServerGeminiStreamEvent>;
