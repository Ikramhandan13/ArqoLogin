...
import { retryWithBackoff, isRetryableError, DEFAULT_MAX_ATTEMPTS, } from '../utils/retry.js';
import { resolveModel, isGemini2Model, supportsModernFeatures, } from '../config/models.js';
...
export class GeminiChat {
    ...
    constructor(config, systemInstruction = '', tools = [], history = [], resumedSessionData, onModelChanged) {
        this.config = config;
            ...
            try {
                ...
                for (let attempt = 0; attempt < maxAttempts; attempt++) {
                    ...
                    try {
                        ...
                        const stream = await this.makeApiCallAndProcessStream(currentConfigKey, requestContents, prompt_id, signal, role);
