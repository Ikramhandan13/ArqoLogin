...
describe('LocalAgentExecutor', () => {
    ...
    describe('Model Routing', () => {
        it('should use model routing when the agent model is "auto"', async () => {
            ...
            expect(mockSendMessageStream).toHaveBeenCalledWith(expect.objectContaining({ model: 'routed-model' }), expect.any(Array), expect.any(String), expect.any(AbortSignal), LlmRole.SUBAGENT);
        });
        it('should NOT use model routing when the agent model is NOT "auto"', async () => {
            ...
            expect(mockSendMessageStream).toHaveBeenCalledWith(expect.objectContaining({ model: 'concrete-model' }), expect.any(Array), expect.any(String), expect.any(AbortSignal), LlmRole.SUBAGENT);
        });
    });
